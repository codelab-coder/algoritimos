...
# interfaces gráficas de usuário (GUI) em Python.
...
def prever_classificacao():
    ...
    try:
        # Tentativa de obter os valores inseridos pelo usuário nas
    ...
    # não puderem ser convertidas para números.
        ...
        # entradas devem ser numéricas, com a cor vermelha.
...
# Cria um rótulo dentro do quadro, que é usado para exibir texto ou imagens.
...
# Cria um rótulo dentro do quadro para indicar onde o usuário
        # deve inserir a nota do aluno.
# 'text="Nota do aluno:"' define o texto que erá exibido,
        # orientando o usuário sobre o que aquele campo representa.
rotulo_nota = ttk.Label(quadro,
                        text="Nota do aluno:")
...
# Cria uma caixa de entrada para que o usuário possa
...
# Cria um botão dentro do quadro que permitirá ao usuário
        # executar a classificação do aluno.
# 'text="Classificar"' define o texto que aparecerá no botão,
        # orientando o usuário sobre sua função.
