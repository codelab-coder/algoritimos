...
janela.geometry("400x300")  # Define a janela para ter 400 pixels de largura e 300 pixels de altura.
...
rotulo_altura = ttk.Label(quadro,
                          text="Altura da planta (em metros):")
...
rotulo_agua = ttk.Label(quadro,
                        text="Precisa de muita água? (Sim/Não):")
