...
def verificar_vencedor():
    ...
    # vitória listada na variável 'combinacoes'.
    ...
    for combinacao in combinacoes:
        ...
        # lista 'combinacao' têm o mesmo símbolo ('X' ou 'O')
        # e que nenhum dos botões está vazio. Isso é feito acessando o
        ...
        if botoes[combinacao[0]]['text'] == botoes[combinacao[1]]['text'] == botoes[combinacao[2]]['text'] != "":
            ...
            # Verifica se o vencedor é o jogador humano, que é
