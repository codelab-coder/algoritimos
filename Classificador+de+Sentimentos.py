...
palavras_positivas = [
    ...
    "perfeito", "sensacional", "formidável", "maravilha", "espetacular", "extraordinário"
]
palavras_negativas = [
...
# Lista de palavras que são usadas para negar ou
...
# Essas dimensões são suficientes para acomodar os elementos da
        # interface sem que fiquem muito apertados.
