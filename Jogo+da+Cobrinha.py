...
# Importa a subbiblioteca messagebox de tkinter, usada para exibir
...
# janela da aplicação na tela do usuário.
...
def reiniciar_variaveis():
    ...
    # jogo está ativo e que a lógica do jogo deve continuar executando.
    jogando = True
