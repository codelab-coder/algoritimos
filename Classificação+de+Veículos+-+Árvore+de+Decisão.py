...
rotulo_peso = ttk.Label(quadro,
                        text="Peso do veículo (toneladas):")
...
rotulo_rodas = ttk.Label(quadro,
                         text="Número de rodas:")
...
# 'text="Capacidade de passageiros:"' define o texto que aparece
        ...
        # capacidade de passageiros do veículo.
rotulo_passageiros = ttk.Label(quadro,
                               text="Capacidade de passageiros:")
...
entrada_passageiros.grid(row=3,
                         column=1,
                         padx=10,
                         pady=5)
